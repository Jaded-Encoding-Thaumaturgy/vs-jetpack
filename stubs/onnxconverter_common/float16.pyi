...
def convert_float_to_float16(model, min_positive_val: float = 1e-07, max_finite_val: float = 10000.0, keep_io_types: bool = False, disable_shape_infer: bool = False, op_block_list=None, node_block_list=None, check_fp16_ready: bool = True): ...
...
def convert_float_to_float16_model_path(model_path, min_positive_val: float = 1e-07, max_finite_val: float = 10000.0, keep_io_types: bool = False): ...
