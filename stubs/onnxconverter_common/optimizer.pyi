...
class Solution:
    ...
    @staticmethod
    def add_siso_node(
        node_list: [], begin: LinkedNode, end: LinkedNode, begin_output_name: str, node: LinkedNode
    ) -> []: ...
...
def optimize_onnx_model(
    origin_model: onnx.ModelProto, nchw_inputs: list = None, stop_initializers: list = None
) -> onnx.ModelProto: ...
