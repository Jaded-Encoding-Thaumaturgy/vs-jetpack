...
class Builder:
    ...
    def build_serialized_network(
        self, network: INetworkDefinition, config: IBuilderConfig, kernel_text: typing.Any
    ) -> IHostMemory:
        """
        Builds and serializes a network for the given :class:`INetworkDefinition` and :class:`IBuilderConfig` .
...
class DLAWorkspaceAllocationStrategy:
    """
    ...
    Members:
      ...
      DEFAULT : Each DLA module allocates its workspace memory separately.
    ...
    DEFAULT: typing.ClassVar[DLAWorkspaceAllocationStrategy]  # value = <DLAWorkspaceAllocationStrategy.DEFAULT: 0>
    SHARED_STATIC: typing.ClassVar[
        DLAWorkspaceAllocationStrategy
    ]  # value = <DLAWorkspaceAllocationStrategy.SHARED_STATIC: 1>
    __members__: typing.ClassVar[
        dict[str, DLAWorkspaceAllocationStrategy]
    ]  # value = {'DEFAULT': <DLAWorkspaceAllocationStrategy.DEFAULT: 0>, 'SHARED_STATIC': <DLAWorkspaceAllocationStrategy.SHARED_STATIC: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class IGpuAllocator(IVersionedInterface):
    ...
    def __init__(self) -> None: ...
    def allocate(
        self, size: typing.SupportsInt, alignment: typing.SupportsInt, flags: typing.SupportsInt
    ...
    def allocate_async(
        ...
        :returns: The address of the allocated memory
        """
    def deallocate(self, memory: typing_extensions.CapsuleType) -> builtins.bool:
        """
...
class INetworkDefinition:
    ...
    @typing.overload
    def add_plugin(self, func: collections.abc.Callable, aot: builtins.bool) -> IPluginV3Layer: ...
    ...
    def add_plugin_v3(
        self,
        inputs: collections.abc.Sequence[ITensor],
        shape_inputs: collections.abc.Sequence[ITensor],
        plugin: IPluginV3,
    ) -> IPluginV3Layer:
        """
        Add a plugin layer to the network using an :class:`IPluginV3` interface.
...
class IPluginCreatorV3Quick(IPluginCreatorInterface, IVersionedInterface):
    ...
    def create_plugin(
        ...
        name: str,
        namespace: str,
        field_collection: PluginFieldCollection_,
        phase: TensorRTPhase,
        quickPluginType: QuickPluginCreationRequest,
    ) -> IPluginV3: ...
...
class ISymExprs:
    ...
    def __len__(self) -> int: ...
    def __setitem__(self, arg0: typing.SupportsInt, arg1: ISymExpr) -> builtins.bool: ...
    @property
    def nbSymExprs(self) -> int: ...
    @nbSymExprs.setter
    def nbSymExprs(self, arg1: typing.SupportsInt) -> builtins.bool: ...
...
class QuickPluginCreationRequest:
    ...
    __members__: typing.ClassVar[
        dict[str, QuickPluginCreationRequest]
    ]  # value = {'UNKNOWN': <QuickPluginCreationRequest.UNKNOWN: 0>, 'PREFER_JIT': <QuickPluginCreationRequest.PREFER_JIT: 1>, 'PREFER_AOT': <QuickPluginCreationRequest.PREFER_AOT: 2>, 'STRICT_JIT': <QuickPluginCreationRequest.STRICT_JIT: 3>, 'STRICT_AOT': <QuickPluginCreationRequest.STRICT_AOT: 4>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class Runtime:
    ...
    dla_workspace_allocation_strategy: DLAWorkspaceAllocationStrategy
