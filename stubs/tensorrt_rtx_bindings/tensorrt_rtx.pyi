...
class ComputeCapability:
    ...
    __members__: typing.ClassVar[dict[str, ComputeCapability]]  # value = {'NONE': <ComputeCapability.NONE: 0>, 'CURRENT': <ComputeCapability.CURRENT: 1>, 'SM75': <ComputeCapability.SM75: 75>, 'SM80': <ComputeCapability.SM80: 80>, 'SM86': <ComputeCapability.SM86: 86>, 'SM89': <ComputeCapability.SM89: 89>, 'SM120': <ComputeCapability.SM120: 120>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class CudaGraphStrategy:
    ...
    __members__: typing.ClassVar[dict[str, CudaGraphStrategy]]  # value = {'DISABLED': <CudaGraphStrategy.DISABLED: 0>, 'WHOLE_GRAPH_CAPTURE': <CudaGraphStrategy.WHOLE_GRAPH_CAPTURE: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __ge__(self, other: typing.Any) -> bool:
        ...
...
class DynamicShapesKernelSpecializationStrategy:
    ...
    """
    EAGER: typing.ClassVar[DynamicShapesKernelSpecializationStrategy]  # value = <DynamicShapesKernelSpecializationStrategy.EAGER: 1>
    LAZY: typing.ClassVar[DynamicShapesKernelSpecializationStrategy]  # value = <DynamicShapesKernelSpecializationStrategy.LAZY: 0>
    NONE: typing.ClassVar[DynamicShapesKernelSpecializationStrategy]  # value = <DynamicShapesKernelSpecializationStrategy.NONE: 2>
    __members__: typing.ClassVar[dict[str, DynamicShapesKernelSpecializationStrategy]]  # value = {'LAZY': <DynamicShapesKernelSpecializationStrategy.LAZY: 0>, 'EAGER': <DynamicShapesKernelSpecializationStrategy.EAGER: 1>, 'NONE': <DynamicShapesKernelSpecializationStrategy.NONE: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __ge__(self, other: typing.Any) -> bool:
        ...
...
class EngineInvalidityDiagnostics:
    ...
    INSUFFICIENT_GPU_MEMORY: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.INSUFFICIENT_GPU_MEMORY: 16>
    MALFORMED_ENGINE: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.MALFORMED_ENGINE: 32>
    OLD_CUDA_DRIVER: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.OLD_CUDA_DRIVER: 4>
    OLD_CUDA_RUNTIME: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.OLD_CUDA_RUNTIME: 8>
    UNSUPPORTED_CC: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.UNSUPPORTED_CC: 2>
    VERSION_MISMATCH: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.VERSION_MISMATCH: 1>
    __members__: typing.ClassVar[dict[str, EngineInvalidityDiagnostics]]  # value = {'VERSION_MISMATCH': <EngineInvalidityDiagnostics.VERSION_MISMATCH: 1>, 'UNSUPPORTED_CC': <EngineInvalidityDiagnostics.UNSUPPORTED_CC: 2>, 'OLD_CUDA_DRIVER': <EngineInvalidityDiagnostics.OLD_CUDA_DRIVER: 4>, 'OLD_CUDA_RUNTIME': <EngineInvalidityDiagnostics.OLD_CUDA_RUNTIME: 8>, 'INSUFFICIENT_GPU_MEMORY': <EngineInvalidityDiagnostics.INSUFFICIENT_GPU_MEMORY: 16>, 'MALFORMED_ENGINE': <EngineInvalidityDiagnostics.MALFORMED_ENGINE: 32>, 'CUDA_ERROR': <EngineInvalidityDiagnostics.CUDA_ERROR: 64>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __ge__(self, other: typing.Any) -> bool:
        ...
...
class EngineValidity:
    ...
    __members__: typing.ClassVar[dict[str, EngineValidity]]  # value = {'VALID': <EngineValidity.VALID: 0>, 'SUBOPTIMAL': <EngineValidity.SUBOPTIMAL: 1>, 'INVALID': <EngineValidity.INVALID: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class IBuilderConfig:
    ...
    def reset_device_type(self, layer: ILayer) -> None:
        ...
        """
    def set_compute_capability(self, compute_capability: ComputeCapability, index: typing.SupportsInt) -> bool:
        """
...
class IExecutionContext:
    ...
    def infer_shapes(self) -> list[str]:
        ...
        """
    def is_stream_capturable(self, stream: typing.SupportsInt) -> bool:
        """
...
class INetworkDefinition:
    ...
    @typing.overload
    def add_scale_nd(self, input: ITensor, mode: ScaleMode, shift: Weights, scale: Weights, *, power: Weights = None, channel_axis: typing.SupportsInt) -> IScaleLayer: ...
    @typing.overload
    def add_scale_nd(self, input: ITensor, mode: ScaleMode, shift: Weights, *, scale: Weights = None, power: Weights = None, channel_axis: typing.SupportsInt) -> IScaleLayer: ...
    @typing.overload
...
class IPluginV2DynamicExt(IPluginV2DynamicExtBase, IPluginV2):
    ...
    def get_serialization_size(self) -> int:
        ...
        """
    def get_workspace_size(self, in_: collections.abc.Sequence[PluginTensorDesc], out: collections.abc.Sequence[PluginTensorDesc]) -> int:
        """
...
class IPluginV3OneBuild(IPluginCapability, IVersionedInterface):
    ...
    def __init__(self, arg0: IPluginV3OneBuild) -> None:
        ...
    def configure_plugin(self: IPluginV3, in_: collections.abc.Sequence[DynamicPluginTensorDesc], out: collections.abc.Sequence[DynamicPluginTensorDesc]) -> None:
        """
            Configure the plugin.
    ...
    def get_valid_tactics(self: IPluginV3) -> list[int]:
        ...
        """
    def get_workspace_size(self: IPluginV3, in_: collections.abc.Sequence[DynamicPluginTensorDesc], out: collections.abc.Sequence[DynamicPluginTensorDesc]) -> int:
        """
            Return the workspace size (in bytes) required by the plugin.
...
class IPluginV3OneRuntime(IPluginCapability, IVersionedInterface):
    ...
    def get_fields_to_serialize(self: IPluginV3) -> PluginFieldCollection_:
        ...
        """
    def on_shape_change(self: IPluginV3, in_: collections.abc.Sequence[PluginTensorDesc], out: collections.abc.Sequence[PluginTensorDesc]) -> None:
        """
...
class IRuntimeCache:
    ...
    """
    def deserialize(self, blob: collections.abc.Buffer) -> bool:
        """
...
class IRuntimeConfig:
    ...
    def set_execution_context_allocation_strategy(self, strategy: ExecutionContextAllocationStrategy = ...) -> None:
        ...
        """
    def set_runtime_cache(self, cache: ... = None) -> bool:
        """
