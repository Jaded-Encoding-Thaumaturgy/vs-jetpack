...
class APILanguage:
    ...
    __members__: typing.ClassVar[
        dict[str, APILanguage]
    ]  # value = {'CPP': <APILanguage.CPP: 0>, 'PYTHON': <APILanguage.PYTHON: 1>}
...
class AttentionNormalizationOp:
    ...
    __members__: typing.ClassVar[
        dict[str, AttentionNormalizationOp]
    ]  # value = {'NONE': <AttentionNormalizationOp.NONE: 0>, 'SOFTMAX': <AttentionNormalizationOp.SOFTMAX: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class BoundingBoxFormat:
    ...
    __members__: typing.ClassVar[
        dict[str, BoundingBoxFormat]
    ]  # value = {'CORNER_PAIRS': <BoundingBoxFormat.CORNER_PAIRS: 0>, 'CENTER_SIZES': <BoundingBoxFormat.CENTER_SIZES: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class Builder:
    ...
    def build_serialized_network_to_stream(
        self, network: INetworkDefinition, config: IBuilderConfig, writer: IStreamWriter
    ) -> builtins.bool:
        """
    ...
    def get_plugin_registry(self) -> IPluginRegistry:
        ...
        """
    def is_network_supported(self, network: INetworkDefinition, config: IBuilderConfig) -> builtins.bool:
        """
...
class BuilderFlag:
    ...
    Members:
      ...
      REQUIRE_USER_ALLOCATION :
        Build an engine that requires user allocation when creating an execution context.
        This means that runtime allocation will not be enabled even when the tensor dimensions exceed the limits
        for static allocation, and ensures that inference will support graph capture unless the network includes
        operations such as data-dependent dynamic shapes (INonZeroLayer, ITripLimitLayer, etc.) that require
        runtime allocation. If such operations are present, the engine build will fail with an error message.
    """
    ...
    REQUIRE_USER_ALLOCATION: typing.ClassVar[BuilderFlag]  # value = <BuilderFlag.REQUIRE_USER_ALLOCATION: 28>
...
class ComputeCapability:
    ...
    CURRENT: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.CURRENT: 1>
    NONE: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.NONE: 0>
    SM120: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.SM120: 120>
    SM121: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.SM121: 121>
    SM75: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.SM75: 75>
    SM80: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.SM80: 80>
    SM86: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.SM86: 86>
    SM89: typing.ClassVar[ComputeCapability]  # value = <ComputeCapability.SM89: 89>
    __members__: typing.ClassVar[
        dict[str, ComputeCapability]
    ]  # value = {'NONE': <ComputeCapability.NONE: 0>, 'CURRENT': <ComputeCapability.CURRENT: 1>, 'SM75': <ComputeCapability.SM75: 75>, 'SM80': <ComputeCapability.SM80: 80>, 'SM86': <ComputeCapability.SM86: 86>, 'SM89': <ComputeCapability.SM89: 89>, 'SM120': <ComputeCapability.SM120: 120>, 'SM121': <ComputeCapability.SM121: 121>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class CudaGraphStrategy:
    ...
    Members:
      ...
      DISABLED : Do not use CUDA graphs optimizations for inference.

      WHOLE_GRAPH_CAPTURE : Stream capture the graph and run the captured graph for inference.
    """

    DISABLED: typing.ClassVar[CudaGraphStrategy]  # value = <CudaGraphStrategy.DISABLED: 0>
    WHOLE_GRAPH_CAPTURE: typing.ClassVar[CudaGraphStrategy]  # value = <CudaGraphStrategy.WHOLE_GRAPH_CAPTURE: 1>
    __members__: typing.ClassVar[
        dict[str, CudaGraphStrategy]
    ]  # value = {'DISABLED': <CudaGraphStrategy.DISABLED: 0>, 'WHOLE_GRAPH_CAPTURE': <CudaGraphStrategy.WHOLE_GRAPH_CAPTURE: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class DataType:
    ...
    Members:
      ...
      UINT8 :
        ...
        ``uint8`` conversions are not supported for {``int8``, ``int32``, ``builtins.bool``}.
    ...
    __members__: typing.ClassVar[
        dict[str, DataType]
    ]  # value = {'FLOAT': <DataType.FLOAT: 0>, 'HALF': <DataType.HALF: 1>, 'BF16': <DataType.BF16: 7>, 'INT8': <DataType.INT8: 2>, 'INT32': <DataType.INT32: 3>, 'INT64': <DataType.INT64: 8>, 'BOOL': <DataType.BOOL: 4>, 'UINT8': <DataType.UINT8: 5>, 'FP8': <DataType.FP8: 6>, 'INT4': <DataType.INT4: 9>, 'FP4': <DataType.FP4: 10>, 'E8M0': <DataType.E8M0: 11>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class DeviceType:
    ...
    __members__: typing.ClassVar[
        dict[str, DeviceType]
    ]  # value = {'GPU': <DeviceType.GPU: 0>, 'DLA': <DeviceType.DLA: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class DimensionOperation:
    ...
    __members__: typing.ClassVar[
        dict[str, DimensionOperation]
    ]  # value = {'SUM': <DimensionOperation.SUM: 0>, 'PROD': <DimensionOperation.PROD: 1>, 'MAX': <DimensionOperation.MAX: 2>, 'MIN': <DimensionOperation.MIN: 3>, 'SUB': <DimensionOperation.SUB: 4>, 'EQUAL': <DimensionOperation.EQUAL: 5>, 'LESS': <DimensionOperation.LESS: 6>, 'FLOOR_DIV': <DimensionOperation.FLOOR_DIV: 7>, 'CEIL_DIV': <DimensionOperation.CEIL_DIV: 8>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class Dims:
    ...
    @typing.overload
    def __eq__(self, arg0: list) -> builtins.bool: ...
    @typing.overload
    def __eq__(self, arg0: tuple) -> builtins.bool: ...
    @typing.overload
...
class Dims4(Dims):
    ...
    @typing.overload
    def __init__(
        self, dim0: typing.SupportsInt, dim1: typing.SupportsInt, dim2: typing.SupportsInt, dim3: typing.SupportsInt
    ) -> None: ...
    @typing.overload
    def __init__(self, shape: collections.abc.Sequence[typing.SupportsInt]) -> None: ...
...
class DynamicShapesKernelSpecializationStrategy:
    ...
    Members:
      ...
      LAZY : Lazy compilation of shape-specialized kernels for new shape inputs, use a fallback kernel till compilation is complete.

      EAGER : Eager compilation of shape-specialized kernels for all shape inputs.

      NONE : No kernel specialization, always use a fallback kernel.
    """

    EAGER: typing.ClassVar[
        DynamicShapesKernelSpecializationStrategy
    ]  # value = <DynamicShapesKernelSpecializationStrategy.EAGER: 1>
    LAZY: typing.ClassVar[
        DynamicShapesKernelSpecializationStrategy
    ]  # value = <DynamicShapesKernelSpecializationStrategy.LAZY: 0>
    NONE: typing.ClassVar[
        DynamicShapesKernelSpecializationStrategy
    ]  # value = <DynamicShapesKernelSpecializationStrategy.NONE: 2>
    __members__: typing.ClassVar[
        dict[str, DynamicShapesKernelSpecializationStrategy]
    ]  # value = {'LAZY': <DynamicShapesKernelSpecializationStrategy.LAZY: 0>, 'EAGER': <DynamicShapesKernelSpecializationStrategy.EAGER: 1>, 'NONE': <DynamicShapesKernelSpecializationStrategy.NONE: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class EngineCapability:
    ...
    ]  # value = {'STANDARD': <EngineCapability.STANDARD: 0>, 'SAFETY': <EngineCapability.SAFETY: 1>, 'DLA_STANDALONE': <EngineCapability.DLA_STANDALONE: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class EngineInvalidityDiagnostics:
    """
    Members:

      VERSION_MISMATCH : TensorRT-RTX version mismatch

      UNSUPPORTED_CC : Unsupported compute capability

      OLD_CUDA_DRIVER : CUDA driver too old

      OLD_CUDA_RUNTIME : CUDA runtime too old

      INSUFFICIENT_GPU_MEMORY : Insufficient GPU memory

      MALFORMED_ENGINE : Serialized engine does not conform to expected format

      CUDA_ERROR : Incorrect installation of CUDA driver or runtime
    """

    CUDA_ERROR: typing.ClassVar[EngineInvalidityDiagnostics]  # value = <EngineInvalidityDiagnostics.CUDA_ERROR: 64>
    INSUFFICIENT_GPU_MEMORY: typing.ClassVar[
        EngineInvalidityDiagnostics
    ]  # value = <EngineInvalidityDiagnostics.INSUFFICIENT_GPU_MEMORY: 16>
    MALFORMED_ENGINE: typing.ClassVar[
        EngineInvalidityDiagnostics
    ]  # value = <EngineInvalidityDiagnostics.MALFORMED_ENGINE: 32>
    OLD_CUDA_DRIVER: typing.ClassVar[
        EngineInvalidityDiagnostics
    ]  # value = <EngineInvalidityDiagnostics.OLD_CUDA_DRIVER: 4>
    OLD_CUDA_RUNTIME: typing.ClassVar[
        EngineInvalidityDiagnostics
    ]  # value = <EngineInvalidityDiagnostics.OLD_CUDA_RUNTIME: 8>
    UNSUPPORTED_CC: typing.ClassVar[
        EngineInvalidityDiagnostics
    ]  # value = <EngineInvalidityDiagnostics.UNSUPPORTED_CC: 2>
    VERSION_MISMATCH: typing.ClassVar[
        EngineInvalidityDiagnostics
    ]  # value = <EngineInvalidityDiagnostics.VERSION_MISMATCH: 1>
    __members__: typing.ClassVar[
        dict[str, EngineInvalidityDiagnostics]
    ]  # value = {'VERSION_MISMATCH': <EngineInvalidityDiagnostics.VERSION_MISMATCH: 1>, 'UNSUPPORTED_CC': <EngineInvalidityDiagnostics.UNSUPPORTED_CC: 2>, 'OLD_CUDA_DRIVER': <EngineInvalidityDiagnostics.OLD_CUDA_DRIVER: 4>, 'OLD_CUDA_RUNTIME': <EngineInvalidityDiagnostics.OLD_CUDA_RUNTIME: 8>, 'INSUFFICIENT_GPU_MEMORY': <EngineInvalidityDiagnostics.INSUFFICIENT_GPU_MEMORY: 16>, 'MALFORMED_ENGINE': <EngineInvalidityDiagnostics.MALFORMED_ENGINE: 32>, 'CUDA_ERROR': <EngineInvalidityDiagnostics.CUDA_ERROR: 64>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class EngineStat:
    ...
    __members__: typing.ClassVar[
        dict[str, EngineStat]
    ]  # value = {'TOTAL_WEIGHTS_SIZE': <EngineStat.TOTAL_WEIGHTS_SIZE: 0>, 'STRIPPED_WEIGHTS_SIZE': <EngineStat.STRIPPED_WEIGHTS_SIZE: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class EngineValidity:
    ...
    Members:
      ...
      VALID : Engine is likely to be valid on the current system

      SUBOPTIMAL : Engine is likely to be valid but may show reduced performance

      INVALID : Engine is invalid on the current system
    """

    INVALID: typing.ClassVar[EngineValidity]  # value = <EngineValidity.INVALID: 2>
    SUBOPTIMAL: typing.ClassVar[EngineValidity]  # value = <EngineValidity.SUBOPTIMAL: 1>
    VALID: typing.ClassVar[EngineValidity]  # value = <EngineValidity.VALID: 0>
    __members__: typing.ClassVar[
        dict[str, EngineValidity]
    ]  # value = {'VALID': <EngineValidity.VALID: 0>, 'SUBOPTIMAL': <EngineValidity.SUBOPTIMAL: 1>, 'INVALID': <EngineValidity.INVALID: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ExecutionContextAllocationStrategy:
    ...
    ON_PROFILE_CHANGE: typing.ClassVar[
        ExecutionContextAllocationStrategy
    ]  # value = <ExecutionContextAllocationStrategy.ON_PROFILE_CHANGE: 1>
    STATIC: typing.ClassVar[
        ExecutionContextAllocationStrategy
    ]  # value = <ExecutionContextAllocationStrategy.STATIC: 0>
    USER_MANAGED: typing.ClassVar[
        ExecutionContextAllocationStrategy
    ]  # value = <ExecutionContextAllocationStrategy.USER_MANAGED: 2>
    __members__: typing.ClassVar[
        dict[str, ExecutionContextAllocationStrategy]
    ]  # value = {'STATIC': <ExecutionContextAllocationStrategy.STATIC: 0>, 'ON_PROFILE_CHANGE': <ExecutionContextAllocationStrategy.ON_PROFILE_CHANGE: 1>, 'USER_MANAGED': <ExecutionContextAllocationStrategy.USER_MANAGED: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class FillOperation:
    ...
    __members__: typing.ClassVar[
        dict[str, FillOperation]
    ]  # value = {'LINSPACE': <FillOperation.LINSPACE: 0>, 'RANDOM_UNIFORM': <FillOperation.RANDOM_UNIFORM: 1>, 'RANDOM_NORMAL': <FillOperation.RANDOM_NORMAL: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class GatherMode:
    ...
    __members__: typing.ClassVar[
        dict[str, GatherMode]
    ]  # value = {'DEFAULT': <GatherMode.DEFAULT: 0>, 'ELEMENT': <GatherMode.ELEMENT: 1>, 'ND': <GatherMode.ND: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class HardwareCompatibilityLevel:
    ...
    SAME_COMPUTE_CAPABILITY: typing.ClassVar[
        HardwareCompatibilityLevel
    ]  # value = <HardwareCompatibilityLevel.SAME_COMPUTE_CAPABILITY: 2>
    __members__: typing.ClassVar[
        dict[str, HardwareCompatibilityLevel]
    ]  # value = {'NONE': <HardwareCompatibilityLevel.NONE: 0>, 'AMPERE_PLUS': <HardwareCompatibilityLevel.AMPERE_PLUS: 1>, 'SAME_COMPUTE_CAPABILITY': <HardwareCompatibilityLevel.SAME_COMPUTE_CAPABILITY: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class IAttention:
    ...
    def get_output(self, index: typing.SupportsInt) -> ITensor:
        ...
        :returns: The tensor, or :class:`None` if it is out of range.
        """
    def set_input(self, index: typing.SupportsInt, tensor: ITensor) -> builtins.bool:
        """
...
class IBuilderConfig:
    ...
    def add_optimization_profile(self, profile: IOptimizationProfile) -> int:
        ...
        :arg profile: The new optimization profile, which must satisfy ``builtins.bool(profile) == True``

        :returns: The index of the optimization profile (starting from 0) if the input is valid, or -1 if the input is
                    not valid.
        """
    def can_run_on_DLA(self, layer: ILayer) -> builtins.bool:
        """
        Check if the layer can run on DLA.

        :arg layer: The layer to check

        :returns: A `builtins.bool` indicating whether the layer can run on DLA
        """
    ...
    def create_timing_cache(self, serialized_timing_cache: collections.abc.Buffer) -> ITimingCache:
        ...
        """
    def get_compute_capability(self, index: typing.SupportsInt) -> ComputeCapability:
        """
    ...
    def get_device_type(self, layer: ILayer) -> DeviceType:
        ...
        """
    def get_flag(self, flag: BuilderFlag) -> builtins.bool:
        """
    ...
    def get_memory_pool_limit(self, pool: MemoryPoolType) -> int:
        ...
        """
    def get_preview_feature(self, feature: PreviewFeature) -> builtins.bool:
        """
    ...
    def get_timing_cache(self) -> ITimingCache:
        ...
        """
    def is_device_type_set(self, layer: ILayer) -> builtins.bool:
        """
    ...
    def reset_device_type(self, layer: ILayer) -> None:
        ...
        """
    def set_compute_capability(self, compute_capability: ComputeCapability, index: typing.SupportsInt) -> builtins.bool:
        """
    ...
    def set_memory_pool_limit(self, pool: MemoryPoolType, pool_size: typing.SupportsInt) -> None:
        ...
        """
    def set_preview_feature(self, feature: PreviewFeature, enable: builtins.bool) -> None:
        """
    ...
    def set_tactic_sources(self, tactic_sources: typing.SupportsInt) -> builtins.bool:
        ...
        :returns: A `builtins.bool` indicating whether the tactic sources in the build configuration were updated. The tactic sources in the build configuration will not be updated if the provided value is invalid.
        """
    def set_timing_cache(self, cache: ITimingCache, ignore_mismatch: builtins.bool) -> builtins.bool:
        """
        ...
        ``builtins.bool(ignore_mismatch) == True`` skips strict verification and allows loading cache created from a different device.
    ...
    def l2_limit_for_tiling(self, arg1: typing.SupportsInt) -> builtins.bool: ...
    @property
    ...
    @property
    def num_compute_capabilities(self) -> int:
        """
        :ivar num_compute_capabilities: The number of target compute capabilities for building the engine.
        """
    @num_compute_capabilities.setter
    def num_compute_capabilities(self, arg1: typing.SupportsInt) -> None: ...
    @property
...
class ICudaEngine:
    ...
    def get_weight_streaming_automatic_budget(self) -> int:
        ...
        """
    def is_debug_tensor(self, name: str) -> builtins.bool:
        """
        Determine whether the given name corresponds to a debug tensor.

        :arg name: The tensor name.
        """
    def is_shape_inference_io(self, name: str) -> builtins.bool:
        """
...
class ICumulativeLayer(ILayer):
    ...
    :ivar exclusive: :class:`builtins.bool` Specifies whether it is an exclusive cumulative or inclusive cumulative.
    :ivar reverse: :class:`builtins.bool` Specifies whether the cumulative operation should be applied backward.
...
class IDimensionExpr:
    ...
    def is_constant(self) -> builtins.bool:
        ...
        """
    def is_size_tensor(self) -> builtins.bool:
        """
...
class IEinsumLayer(ILayer):
    ...
    The layer can have one or more inputs of rank >= 0. All the inputs must be of same data type. This layer supports all TensorRT data types except :class:`builtins.bool`.
...
class IErrorRecorder:
    ...
    def get_error_desc(self, arg0: typing.SupportsInt) -> str:
        ...
        """
    def has_overflowed(self) -> builtins.bool:
        """
    ...
    def num_errors(self) -> int:
        ...
        """
    def report_error(self, arg0: ErrorCodeTRT, arg1: str) -> builtins.bool:
        """
        Clear the error stack on the error recorder.
...
class IExecutionContext:
    ...
    :ivar debug_sync: :class:`builtins.bool` The debug sync flag. If this flag is set to true, the :class:`ICudaEngine` will log the successful execution for each kernel during execute_v2().
    ...
    def execute_async_v3(self, stream_handle: typing.SupportsInt) -> builtins.bool:
        ...
        """
    def execute_v2(self, bindings: collections.abc.Sequence[typing.SupportsInt]) -> builtins.bool:
        """
    ...
    def get_debug_listener(self) -> IDebugListener:
        ...
        """
    def get_debug_state(self, name: str) -> builtins.bool:
        """
    ...
    def infer_shapes(self) -> list[str]:
        ...
        * is_shape_inference_io(t) is True and the tensor's address has not yet been set.
        ...
        """
    def is_stream_capturable(self, stream: typing.SupportsInt) -> builtins.bool:
        """
        Check if the execution context is stream capturable.

        :param stream: The CUDA stream to check capturability for.

        :returns: True if the execution context is stream capturable with the given stream, False otherwise.
        """
    def report_to_profiler(self) -> builtins.bool:
        """
        ...
        """
    def set_all_tensors_debug_state(self, flag: builtins.bool) -> builtins.bool:
        """
    ...
    def set_communicator(self, communicator: types.CapsuleType) -> builtins.bool:
        ...
        """
    def set_debug_listener(self, listener: IDebugListener) -> builtins.bool:
        """
    ...
    def set_device_memory(self, memory: typing.SupportsInt, size: typing.SupportsInt) -> None:
        ...
        """
    def set_input_consumed_event(self, event: typing.SupportsInt) -> builtins.bool:
        """
        ...
        """
    @typing.overload
    def set_input_shape(self, name: str, shape: tuple) -> builtins.bool:
        """
        ...
        """
    @typing.overload
    def set_input_shape(self, name: str, shape: list) -> builtins.bool:
        """
        Set shape for the given input tensor.
        ...
        """
    @typing.overload
    def set_input_shape(self, name: str, shape: Dims) -> builtins.bool:
        """
        Set shape for the given input tensor.
    ...
    def set_optimization_profile_async(
        self, profile_index: typing.SupportsInt, stream_handle: typing.SupportsInt
    ) -> builtins.bool:
        """
        ...
        """
    def set_output_allocator(self, name: str, output_allocator: IOutputAllocator) -> builtins.bool:
        """
        ...
        """
    def set_tensor_address(self, name: str, memory: typing.SupportsInt) -> builtins.bool:
        """
        ...
        """
    def set_tensor_debug_state(self, name: str, flag: builtins.bool) -> builtins.bool:
        """
...
class IExprBuilder:
    ...
    def constant(self, arg0: typing.SupportsInt) -> IDimensionExpr:
        ...
        """
    def declare_size_tensor(
        self, arg0: typing.SupportsInt, arg1: IDimensionExpr, arg2: IDimensionExpr
    ) -> IDimensionExpr:
        """
...
class IGridSampleLayer(ILayer):
    ...
    :ivar align_corners: class:`builtins.bool` the align mode to use. Defaults to False.
    :ivar sample_mode: :class:`SampleMode` The sample mode to use. Defaults to FILL.
    """

    align_corners: builtins.bool
...
class IIdentityLayer(ILayer):
    ...
    (``float32`` | ``float16`` | ``int32`` | ``builtins.bool``) -> (``float32`` | ``float16`` | ``int32`` | ``builtins.bool``)
...
class IIfConditional:
    ...
    def set_condition(self, condition: ITensor) -> IConditionLayer:
        ...
        The ``condition`` tensor must be a 0D data tensor (scalar) with type :class:`builtins.bool`.
...
class ILogger:
    ...
    ::
        ...
        class MyLogger(trt.ILogger):
            ...
            def log(self, severity, msg): ...  # Your implementation here
    ...
    class Severity:
        ...
        __members__: typing.ClassVar[
            dict[str, ILogger.Severity]
        ]  # value = {'INTERNAL_ERROR': <Severity.INTERNAL_ERROR: 0>, 'ERROR': <Severity.ERROR: 1>, 'WARNING': <Severity.WARNING: 2>, 'INFO': <Severity.INFO: 3>, 'VERBOSE': <Severity.VERBOSE: 4>}
        def __eq__(self, other: object) -> builtins.bool: ...
        def __ge__(self, other: typing.Any) -> builtins.bool: ...
        def __getstate__(self) -> int: ...
        def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class ILoop:
    ...
    name: str
    def add_iterator(
        self, tensor: ITensor, axis: typing.SupportsInt = 0, reverse: builtins.bool = False
    ) -> IIteratorLayer:
        """
...
class IMoELayer(ILayer):
    ...
    def set_gated_biases(self, fc_gate_biases: ITensor, fc_up_biases: ITensor, fc_down_biases: ITensor) -> None:
        ...
        """
    def set_gated_weights(
        self, fc_gate_weights: ITensor, fc_up_weights: ITensor, fc_down_weights: ITensor, activation_type: MoEActType
    ) -> None:
        """
    ...
    def set_input(self, index: typing.SupportsInt, tensor: ITensor) -> None:
        ...
        """
    def set_quantization_dynamic_dbl_q(
        self,
        fc_down_activation_dbl_q_scale: ITensor,
        data_type: DataType,
        block_shape: Dims,
        dyn_q_output_scale_type: DataType,
    ) -> None:
    ...
    def set_quantization_static(self, fc_down_activation_scale: ITensor, data_type: DataType) -> None:
        ...
        :arg data_type: The data type for the quantization.
        """
    def set_swiglu_params(
        self, limit: typing.SupportsFloat, alpha: typing.SupportsFloat, beta: typing.SupportsFloat
    ) -> None:
        """
...
class INetworkDefinition:
    ...
    def add_convolution_nd(
        self,
        input: ITensor,
        num_output_maps: typing.SupportsInt,
        kernel_shape: Dims,
        kernel: Weights,
        bias: Weights = None,
    ) -> IConvolutionLayer:
        ...
        """
    def add_cumulative(
        self, input: ITensor, axis: ITensor, op: CumulativeOperation, exclusive: builtins.bool, reverse: builtins.bool
    ) -> ICumulativeLayer:
        """
    ...
    def add_dist_collective(
        ...
        """
    def add_dynamic_quantize(
        self,
        input: ITensor,
        axis: typing.SupportsInt,
        ...
        """
    def add_dynamic_quantize_v2(
        self, input: ITensor, block_shape: Dims, output_type: DataType, scale_type: DataType
    ) -> IDynamicQuantizeLayer:
        """
        Add a dynamic quantization layer to the network.
        See :class:`IDynamicQuantizeLayer` for more information.
    ...
    def add_grid_sample(self, input: ITensor, grid: ITensor) -> IGridSampleLayer:
        ...
        :ivar align_corners: class:`builtins.bool` the align mode to use in the layer. Default is False.
    ...
    def add_input(self, name: str, dtype: DataType, shape: Dims) -> ITensor:
        ...
        """
    def add_kv_cache_update(
        self, cache: ITensor, update: ITensor, write_indices: ITensor, cache_mode: KVCacheMode
    ) -> IKVCacheUpdateLayer:
        """
    ...
    def add_matrix_multiply(
        self, input0: ITensor, op0: MatrixOperation, input1: ITensor, op1: MatrixOperation
    ) -> IMatrixMultiplyLayer:
        """
        ...
        """
    def add_moe(
        self, hidden_states: ITensor, selected_experts_for_tokens: ITensor, scores_for_selected_experts: ITensor
    ) -> IMoELayer:
        """
    ...
    @typing.overload
    def add_nms(
        self, boxes: ITensor, scores: ITensor, max_output_boxes_per_class: ITensor, indices_type: DataType
    ) -> INMSLayer:
        """
        Add a non-maximum suppression layer to the network.
        See :class:`INMSLayer` for more information.
    ...
    def add_normalization(
        self, input: ITensor, scale: ITensor, bias: ITensor, axesMask: typing.SupportsInt
    ) -> INormalizationLayer:
        """
    ...
    def add_ragged_softmax(self, input: ITensor, bounds: ITensor) -> IRaggedSoftMaxLayer:
        ...
        """
    def add_reduce(
        self, input: ITensor, op: ReduceOperation, axes: typing.SupportsInt, keep_dims: builtins.bool
    ) -> IReduceLayer:
        """
    ...
    def add_rotary_embedding(
        ...
        cos_cache: ITensor,
        sin_cache: ITensor,
        interleaved: builtins.bool,
        rotary_embedding_dim: typing.SupportsInt,
    ) -> IRotaryEmbeddingLayer:
        """
        ...
        """
    def add_scale(
        self, input: ITensor, mode: ScaleMode, shift: Weights = None, scale: Weights = None, power: Weights = None
    ) -> IScaleLayer:
        """
    ...
    def add_scale_nd(
        ...
        scale: Weights = None,
        power: Weights = None,
        channel_axis: typing.SupportsInt = ...,
    ) -> IScaleLayer:
        """
    ...
    @typing.overload
    def add_topk(
        self, input: ITensor, op: TopKOperation, k: typing.SupportsInt, axes: typing.SupportsInt
    ) -> ITopKLayer:
        """
    ...
    @typing.overload
    def add_topk(
        self, input: ITensor, op: TopKOperation, k: typing.SupportsInt, axes: typing.SupportsInt, indices_type: DataType
    ) -> ITopKLayer:
        """
        Add a TopK layer to the network.
        See :class:`ITopKLayer` for more information.
    ...
    def add_unsqueeze(self, input: ITensor, axes: ITensor) -> IUnsqueezeLayer:
        ...
        """
    def are_weights_marked_refittable(self, name: str) -> builtins.bool:
        """
    ...
    def get_output(self, index: typing.SupportsInt) -> ITensor:
        ...
        :returns: The tensor, or :class:`None` if it is out of range.
        """
    def is_debug_tensor(self, tensor: ITensor) -> builtins.bool:
        """
        Check if a tensor is marked as debug.

        :arg tensor: The tensor to be checked.
        """
    def mark_debug(self, tensor: ITensor) -> builtins.bool:
        """
    ...
    def mark_output(self, tensor: ITensor) -> None:
        ...
        """
    def mark_output_for_shapes(self, tensor: ITensor) -> builtins.bool:
        """
        ...
        """
    def mark_unfused_tensors_as_debug_tensors(self) -> builtins.bool:
        """
        ...
        """
    def mark_weights_refittable(self, name: str) -> builtins.bool:
        """
    ...
    def remove_tensor(self, tensor: ITensor) -> None:
        ...
        """
    def set_weights_name(self, weights: Weights, name: str) -> builtins.bool:
        """
        ...
        """
    def unmark_debug(self, tensor: ITensor) -> builtins.bool:
        """
    ...
    def unmark_output(self, tensor: ITensor) -> None:
        ...
        """
    def unmark_output_for_shapes(self, tensor: ITensor) -> builtins.bool:
        """
        ...
        """
    def unmark_unfused_tensors_as_debug_tensors(self) -> builtins.bool:
        """
        ...
        """
    def unmark_weights_refittable(self, name: str) -> builtins.bool:
        """
...
class IOptimizationProfile:
    ...
    :class:`IOptimizationProfile` implements :func:`__nonzero__` and :func:`__bool__` such that evaluating a profile as a :class:`builtins.bool` (e.g. ``if profile:``) will check whether the optimization profile can be passed to an IBuilderConfig object. This will perform partial validation, by e.g. checking that the maximum dimensions are at least as large as the optimum dimensions, and that the optimum dimensions are always as least as large as the minimum dimensions. Some validation steps require knowledge of the network definition and are deferred to engine build time.
    ...
    def set_shape_input(
        self,
        input: str,
        min: collections.abc.Sequence[typing.SupportsInt],
        opt: collections.abc.Sequence[typing.SupportsInt],
        max: collections.abc.Sequence[typing.SupportsInt],
    ) -> None:
        """
    ...
    def extra_memory_target(self, arg1: typing.SupportsFloat) -> builtins.bool: ...
...
class IOutputAllocator:
    ...
    ::
        ...
        class MyOutputAllocator(trt.IOutputAllocator):
            ...
            def reallocate_output(self, tensor_name, memory, size, alignment): ...  # Your implementation here
            def reallocate_output_async(
                self, tensor_name, memory, size, alignment, stream
            ): ...  # Your implementation here
            def notify_shape(self, tensor_name, shape): ...  # Your implementation here
...
class IPluginV2DynamicExt(IPluginV2DynamicExtBase, IPluginV2):
    ...
    def configure_plugin(
        self,
        pos: collections.abc.Sequence[DynamicPluginTensorDesc],
        in_out: collections.abc.Sequence[DynamicPluginTensorDesc],
    ) -> None:
        """
    ...
    def enqueue(
        self,
        input_desc: collections.abc.Sequence[PluginTensorDesc],
        output_desc: collections.abc.Sequence[PluginTensorDesc],
        inputs: collections.abc.Sequence[typing.SupportsInt],
        outputs: collections.abc.Sequence[typing.SupportsInt],
        workspace: typing.SupportsInt,
        stream: typing.SupportsInt,
    ) -> None:
        """
        Execute the layer.
    ...
    def get_output_datatype(
        self, index: typing.SupportsInt, input_types: collections.abc.Sequence[DataType]
    ) -> DataType:
        """
    ...
    def get_output_dimensions(
        self, output_index: typing.SupportsInt, inputs: collections.abc.Sequence[DimsExprs], expr_builder: IExprBuilder
    ) -> DimsExprs:
        """
    ...
    def get_workspace_size(
        self, in_: collections.abc.Sequence[PluginTensorDesc], out: collections.abc.Sequence[PluginTensorDesc]
    ) -> int:
        """
    ...
    def supports_format_combination(
        self,
        pos: typing.SupportsInt,
        in_out: collections.abc.Sequence[PluginTensorDesc],
        num_inputs: typing.SupportsInt,
    ) -> builtins.bool:
        """
...
class IPluginV2Ext(IPluginV2):
    ...
    def configure_plugin(
        ...
        input_shapes: collections.abc.Sequence[Dims],
        output_shapes: collections.abc.Sequence[Dims],
        input_types: collections.abc.Sequence[DataType],
...
class IPluginV3OneBuild(IPluginCapability, IVersionedInterface):
    ...
    def configure_plugin(
        self: IPluginV3,
        in_: collections.abc.Sequence[DynamicPluginTensorDesc],
        out: collections.abc.Sequence[DynamicPluginTensorDesc],
    ) -> None:
        """
        Configure the plugin.
    ...
    def get_output_shapes(
        self: IPluginV3,
        inputs: collections.abc.Sequence[DimsExprs],
        shape_inputs: collections.abc.Sequence[DimsExprs],
        expr_builder: IExprBuilder,
    ) -> list[DimsExprs]:
        """
...
class IPluginV3OneRuntime(IPluginCapability, IVersionedInterface):
    ...
    def on_shape_change(
        self: IPluginV3,
        in_: collections.abc.Sequence[PluginTensorDesc],
        out: collections.abc.Sequence[PluginTensorDesc],
    ) -> None:
        """
...
class IPoolingLayer(ILayer):
    ...
    :ivar average_count_excludes_padding: :class:`builtins.bool` Whether average pooling uses as a denominator the overlap area between the window and the unpadded input. If this is not set, the denominator is the overlap between the pooling window and the padded input. Default: True
    ...
    average_count_excludes_padding: builtins.bool
    padding_mode: PaddingMode
    padding_nd: Dims
    post_padding: Dims
    pre_padding: Dims
...
class IProfiler:
    ...
    ::
        ...
        class MyProfiler(trt.IProfiler):
            ...
            def report_layer_time(self, layer_name, ms): ...  # Your implementation here
...
class IProgressMonitor:
    ...
    def phase_start(self, phase_name: str, parent_phase: str, num_steps: typing.SupportsInt) -> None:
        ...
        of TensorRT.
        """
    def step_complete(self, phase_name: str, step: typing.SupportsInt) -> builtins.bool:
        """
...
class IReduceLayer(ILayer):
    ...
    :ivar keep_dims: :class:`builtins.bool` Specifies whether or not to keep the reduced dimensions for the layer.
    """

    keep_dims: builtins.bool
    op: ReduceOperation
    @property
    def axes(self) -> int: ...
    @axes.setter
...
class IRotaryEmbeddingLayer(ILayer):
    ...
    def rotary_embedding_dim(self, arg1: typing.SupportsInt) -> builtins.bool: ...

class IRuntimeCache:
    """

    A runtime cache for storing runtime compilation details.
    """
    def deserialize(self, blob: collections.abc.Buffer) -> builtins.bool:
        """
    ...
    def reset(self) -> builtins.bool:
        """
        Reset the runtime cache. Clears all entries in the cache.
        """
    def serialize(self) -> IHostMemory:
        """
        Serialize the runtime cache.

        :returns: Memory object containing the serialized runtime cache.
        """
...
class ISerializationConfig:
    ...
    """
    def clear_flag(self, flag: SerializationFlag) -> builtins.bool:
        """
        Clears the serialization flag from the config.
        """
    def get_flag(self, flag: SerializationFlag) -> builtins.bool:
        """
        Check if a serialization flag is set.
        """
    def set_flag(self, flag: SerializationFlag) -> builtins.bool:
        """
...
class IShuffleLayer(ILayer):
    ...
    :ivar zero_is_placeholder: :class:`builtins.bool` The meaning of 0 in reshape dimensions.
...
class IStreamReaderV2:
    ...
    ::
        class MyStreamReader(trt.IStreamReaderV2):
            ...
            def read(self, num_bytes: int, stream: int) -> bytes: ...  # Your implementation here
            def seek(self, offset: int, where: SeekPosition) -> builtins.bool: ...  # Your implementation here
    ...
    def read(self, destination: types.CapsuleType, num_bytes: typing.SupportsInt, stream: typing.SupportsInt) -> int:
        ...
        """
    def seek(self, offset: typing.SupportsInt, where: SeekPosition) -> builtins.bool:
        """
...
class IStreamWriter:
    ...
    ::
        ...
        class MyStreamWriter(trt.IStreamWriter):
            ...
            def write(self, data: bytes) -> int: ...  # Your implementation here
...
class ITensor:
    ...
    :ivar broadcast_across_batch: :class:`builtins.bool` [DEPRECATED] Deprecated in TensorRT 10.0. Always false since the implicit batch dimensions support has been removed.
    ...
    @property
    def is_network_input(self) -> builtins.bool: ...
    @property
    def is_network_output(self) -> builtins.bool: ...
    @property
    def is_shape_tensor(self) -> builtins.bool: ...
...
class ITimingCache:
    ...
    """
    def combine(self, input_cache: ITimingCache, ignore_mismatch: builtins.bool) -> builtins.bool:
        """
        ...
        skipped and return false. ``builtins.bool(ignore_mismatch) == True`` if combining a timing cache
        ...
        :returns: A `builtins.bool` indicating whether the combine operation is done successfully.
        """
    ...
    def reset(self) -> builtins.bool:
        ...
        :returns: A `builtins.bool` indicating whether the reset operation is done successfully.
        """
    def serialize(self) -> IHostMemory:
        """
        ...
        """
    def update(self, key: TimingCacheKey, value: TimingCacheValue) -> builtins.bool:
        """
...
class InterpolationMode:
    ...
    __members__: typing.ClassVar[
        dict[str, InterpolationMode]
    ]  # value = {'NEAREST': <InterpolationMode.NEAREST: 0>, 'LINEAR': <InterpolationMode.LINEAR: 1>, 'CUBIC': <InterpolationMode.CUBIC: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class LayerInformationFormat:
    ...
    __members__: typing.ClassVar[
        dict[str, LayerInformationFormat]
    ]  # value = {'ONELINE': <LayerInformationFormat.ONELINE: 0>, 'JSON': <LayerInformationFormat.JSON: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class LoopOutput:
    ...
    __members__: typing.ClassVar[
        dict[str, LoopOutput]
    ]  # value = {'LAST_VALUE': <LoopOutput.LAST_VALUE: 0>, 'CONCATENATE': <LoopOutput.CONCATENATE: 1>, 'REVERSE': <LoopOutput.REVERSE: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class MatrixOperation:
    ...
    __members__: typing.ClassVar[
        dict[str, MatrixOperation]
    ]  # value = {'NONE': <MatrixOperation.NONE: 0>, 'TRANSPOSE': <MatrixOperation.TRANSPOSE: 1>, 'VECTOR': <MatrixOperation.VECTOR: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class MemoryPoolType:
    ...
    __members__: typing.ClassVar[
        dict[str, MemoryPoolType]
    ]  # value = {'WORKSPACE': <MemoryPoolType.WORKSPACE: 0>, 'DLA_MANAGED_SRAM': <MemoryPoolType.DLA_MANAGED_SRAM: 1>, 'DLA_LOCAL_DRAM': <MemoryPoolType.DLA_LOCAL_DRAM: 2>, 'DLA_GLOBAL_DRAM': <MemoryPoolType.DLA_GLOBAL_DRAM: 3>, 'TACTIC_DRAM': <MemoryPoolType.TACTIC_DRAM: 4>, 'TACTIC_SHARED_MEMORY': <MemoryPoolType.TACTIC_SHARED_MEMORY: 5>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class MoEActType:
    ...
    __members__: typing.ClassVar[
        dict[str, MoEActType]
    ]  # value = {'NONE': <MoEActType.NONE: 0>, 'SILU': <MoEActType.SILU: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class NetworkDefinitionCreationFlag:
    ...
    ]  # value = {'STRONGLY_TYPED': <NetworkDefinitionCreationFlag.STRONGLY_TYPED: 0>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class NodeIndices:
    __hash__: typing.ClassVar[None] = None
    def __bool__(self: collections.abc.Sequence[typing.SupportsInt]) -> builtins.bool:
        """
        Check whether the list is nonempty
        """
    def __contains__(self: collections.abc.Sequence[typing.SupportsInt], x: typing.SupportsInt) -> builtins.bool:
        """
    ...
    def __delitem__(self: collections.abc.Sequence[typing.SupportsInt], arg0: slice) -> None:
        ...
        """
    def __eq__(
        self: collections.abc.Sequence[typing.SupportsInt], arg0: collections.abc.Sequence[typing.SupportsInt]
    ) -> builtins.bool: ...
    @typing.overload
    ...
    @typing.overload
    def __setitem__(
        self: collections.abc.Sequence[typing.SupportsInt], arg0: typing.SupportsInt, arg1: typing.SupportsInt
    ) -> None: ...
    @typing.overload
    def __setitem__(
        self: collections.abc.Sequence[typing.SupportsInt],
        arg0: slice,
    ...
    @typing.overload
    def extend(
        self: collections.abc.Sequence[typing.SupportsInt], L: collections.abc.Sequence[typing.SupportsInt]
    ) -> None:
        """
    ...
    def extend(self: collections.abc.Sequence[typing.SupportsInt], L: collections.abc.Iterable) -> None:
        ...
        """
    def insert(
        self: collections.abc.Sequence[typing.SupportsInt], i: typing.SupportsInt, x: typing.SupportsInt
    ) -> None:
        """
...
class OnnxParser:
    ...
    def get_used_vc_plugin_libraries(self) -> list[str]:
        ...
        """
    def is_subgraph_supported(self, index: typing.SupportsInt) -> builtins.bool:
        """
        ...
        """
    def load_initializer(self, name: str, data: typing.SupportsInt, size: typing.SupportsInt) -> builtins.bool:
        """
    ...
    def parse(self, model: collections.abc.Buffer, path: str = None) -> builtins.bool:
        ...
        """
    def parse_from_file(self, model: str) -> builtins.bool:
        """
        ...
        :returns: true if the model was parsed successfully
        """
    def parse_model_proto(self) -> builtins.bool:
        """
    ...
    def supports_model_v2(self, model: collections.abc.Buffer, path: str = None) -> builtins.bool:
        ...
        """
    def supports_operator(self, op_name: str) -> builtins.bool:
        """
...
class OnnxParserFlag:
    ...
    ENABLE_UINT8_AND_ASYMMETRIC_QUANTIZATION_DLA: typing.ClassVar[
        OnnxParserFlag
    ]  # value = <OnnxParserFlag.ENABLE_UINT8_AND_ASYMMETRIC_QUANTIZATION_DLA: 1>
    ...
    __members__: typing.ClassVar[
        dict[str, OnnxParserFlag]
    ]  # value = {'NATIVE_INSTANCENORM': <OnnxParserFlag.NATIVE_INSTANCENORM: 0>, 'ENABLE_UINT8_AND_ASYMMETRIC_QUANTIZATION_DLA': <OnnxParserFlag.ENABLE_UINT8_AND_ASYMMETRIC_QUANTIZATION_DLA: 1>, 'REPORT_CAPABILITY_DLA': <OnnxParserFlag.REPORT_CAPABILITY_DLA: 2>, 'ENABLE_PLUGIN_OVERRIDE': <OnnxParserFlag.ENABLE_PLUGIN_OVERRIDE: 3>, 'ADJUST_FOR_DLA': <OnnxParserFlag.ADJUST_FOR_DLA: 4>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class OnnxParserRefitter:
    ...
    def refit_from_bytes(self, model: collections.abc.Buffer, path: str = None) -> builtins.bool:
        ...
        """
    def refit_from_file(self, model: str) -> builtins.bool:
        """
        ...
        """
    def refit_model_proto(self) -> builtins.bool:
        """
...
class PaddingMode:
    ...
    __members__: typing.ClassVar[
        dict[str, PaddingMode]
    ]  # value = {'EXPLICIT_ROUND_DOWN': <PaddingMode.EXPLICIT_ROUND_DOWN: 0>, 'EXPLICIT_ROUND_UP': <PaddingMode.EXPLICIT_ROUND_UP: 1>, 'SAME_UPPER': <PaddingMode.SAME_UPPER: 2>, 'SAME_LOWER': <PaddingMode.SAME_LOWER: 3>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class PluginArgDataType:
    ...
    __members__: typing.ClassVar[
        dict[str, PluginArgDataType]
    ]  # value = {'INT8': <PluginArgDataType.INT8: 0>, 'INT16': <PluginArgDataType.INT16: 1>, 'INT32': <PluginArgDataType.INT32: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class PluginCapabilityType:
    ...
    __members__: typing.ClassVar[
        dict[str, PluginCapabilityType]
    ]  # value = {'CORE': <PluginCapabilityType.CORE: 0>, 'BUILD': <PluginCapabilityType.BUILD: 1>, 'RUNTIME': <PluginCapabilityType.RUNTIME: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class PluginCreatorVersion:
    ...
    __members__: typing.ClassVar[
        dict[str, PluginCreatorVersion]
    ]  # value = {'V1': <PluginCreatorVersion.V1: 0>, 'V1_PYTHON': <PluginCreatorVersion.V1_PYTHON: 64>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class PoolingType:
    ...
    __members__: typing.ClassVar[
        dict[str, PoolingType]
    ]  # value = {'MAX': <PoolingType.MAX: 0>, 'AVERAGE': <PoolingType.AVERAGE: 1>, 'MAX_AVERAGE_BLEND': <PoolingType.MAX_AVERAGE_BLEND: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ProfilingVerbosity:
    ...
    __members__: typing.ClassVar[
        dict[str, ProfilingVerbosity]
    ]  # value = {'LAYER_NAMES_ONLY': <ProfilingVerbosity.LAYER_NAMES_ONLY: 0>, 'DETAILED': <ProfilingVerbosity.DETAILED: 2>, 'NONE': <ProfilingVerbosity.NONE: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ReduceOperation:
    ...
    __members__: typing.ClassVar[
        dict[str, ReduceOperation]
    ]  # value = {'SUM': <ReduceOperation.SUM: 0>, 'PROD': <ReduceOperation.PROD: 1>, 'MAX': <ReduceOperation.MAX: 2>, 'MIN': <ReduceOperation.MIN: 3>, 'AVG': <ReduceOperation.AVG: 4>, 'NONE': <ReduceOperation.NONE: 5>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class Refitter:
    ...
    :ivar weights_validation: :class:`builtins.bool` The flag to indicate whether to validate weights in the refitting process.
    """

    error_recorder: IErrorRecorder
    weights_validation: builtins.bool
    def __del__(self) -> None: ...
    ...
    def get_weights_prototype(self, weights_name: str) -> Weights:
        ...
        """
    def refit_cuda_engine(self) -> builtins.bool:
        """
        ...
        """
    def refit_cuda_engine_async(self, stream_handle: typing.SupportsInt) -> builtins.bool:
        """
    ...
    def set_named_weights(self, name: str, weights: Weights) -> builtins.bool:
        ...
        * The dtype of the weights is inconsistent with the dtype returned from calling :func:`get_weights_prototype` with the same name.
        ...
        """
    @typing.overload
    def set_named_weights(self, name: str, weights: Weights, location: TensorLocation) -> builtins.bool:
        """
        ...
        * The dtype of the weights is inconsistent with the dtype returned from calling :func:`get_weights_prototype` with the same name.
        ...
        :returns: ``True`` on success, or ``False`` if new weights are rejected.
        """
    def set_weights(self, layer_name: str, role: WeightsRole, weights: Weights) -> builtins.bool:
        """
        ...
        * The size of weights is inconsistent with the layer’s original specification.
        ...
        :returns: ``True`` on success, or ``False`` if new weights are rejected.
        """
    def unset_named_weights(self, weights_name: str) -> builtins.bool:
        """
...
class ResizeCoordinateTransformation:
    ...
    ALIGN_CORNERS: typing.ClassVar[
        ResizeCoordinateTransformation
    ]  # value = <ResizeCoordinateTransformation.ALIGN_CORNERS: 0>
    ASYMMETRIC: typing.ClassVar[
        ResizeCoordinateTransformation
    ]  # value = <ResizeCoordinateTransformation.ASYMMETRIC: 1>
    HALF_PIXEL: typing.ClassVar[
        ResizeCoordinateTransformation
    ]  # value = <ResizeCoordinateTransformation.HALF_PIXEL: 2>
    __members__: typing.ClassVar[
        dict[str, ResizeCoordinateTransformation]
    ]  # value = {'ALIGN_CORNERS': <ResizeCoordinateTransformation.ALIGN_CORNERS: 0>, 'ASYMMETRIC': <ResizeCoordinateTransformation.ASYMMETRIC: 1>, 'HALF_PIXEL': <ResizeCoordinateTransformation.HALF_PIXEL: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ResizeRoundMode:
    ...
    __members__: typing.ClassVar[
        dict[str, ResizeRoundMode]
    ]  # value = {'HALF_UP': <ResizeRoundMode.HALF_UP: 0>, 'HALF_DOWN': <ResizeRoundMode.HALF_DOWN: 1>, 'FLOOR': <ResizeRoundMode.FLOOR: 2>, 'CEIL': <ResizeRoundMode.CEIL: 3>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ResizeSelector:
    ...
    __members__: typing.ClassVar[
        dict[str, ResizeSelector]
    ]  # value = {'FORMULA': <ResizeSelector.FORMULA: 0>, 'UPPER': <ResizeSelector.UPPER: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class Runtime:
    ...
    engine_host_code_allowed: builtins.bool
    error_recorder: IErrorRecorder
    ...
    def deserialize_cuda_engine(self, stream_reader_v2: IStreamReaderV2) -> ICudaEngine:
        ...
        :returns: The :class:`ICudaEngine`, or None if it could not be deserialized.
        """
    def get_engine_validity(self, buffer: collections.abc.Buffer) -> tuple:
        """
        Get engine validity and diagnostics from serialized engine buffer. Returns tuple of (EngineValidity, diagnostics).
        """
    def get_plugin_registry(self) -> IPluginRegistry:
        """
...
class RuntimePlatform:
    ...
    __members__: typing.ClassVar[
        dict[str, RuntimePlatform]
    ]  # value = {'SAME_AS_BUILD': <RuntimePlatform.SAME_AS_BUILD: 0>, 'WINDOWS_AMD64': <RuntimePlatform.WINDOWS_AMD64: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class SampleMode:
    ...
    __members__: typing.ClassVar[
        dict[str, SampleMode]
    ]  # value = {'STRICT_BOUNDS': <SampleMode.STRICT_BOUNDS: 0>, 'WRAP': <SampleMode.WRAP: 1>, 'CLAMP': <SampleMode.CLAMP: 2>, 'FILL': <SampleMode.FILL: 3>, 'REFLECT': <SampleMode.REFLECT: 4>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ScaleMode:
    ...
    __members__: typing.ClassVar[
        dict[str, ScaleMode]
    ]  # value = {'UNIFORM': <ScaleMode.UNIFORM: 0>, 'CHANNEL': <ScaleMode.CHANNEL: 1>, 'ELEMENTWISE': <ScaleMode.ELEMENTWISE: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class ScatterMode:
    ...
    __members__: typing.ClassVar[
        dict[str, ScatterMode]
    ]  # value = {'ELEMENT': <ScatterMode.ELEMENT: 0>, 'ND': <ScatterMode.ND: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class SeekPosition:
    ...
    __members__: typing.ClassVar[
        dict[str, SeekPosition]
    ]  # value = {'SET': <SeekPosition.SET: 0>, 'CUR': <SeekPosition.CUR: 1>, 'END': <SeekPosition.END: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class SerializationFlag:
    ...
    __members__: typing.ClassVar[
        dict[str, SerializationFlag]
    ]  # value = {'EXCLUDE_WEIGHTS': <SerializationFlag.EXCLUDE_WEIGHTS: 0>, 'EXCLUDE_LEAN_RUNTIME': <SerializationFlag.EXCLUDE_LEAN_RUNTIME: 1>, 'INCLUDE_REFIT': <SerializationFlag.INCLUDE_REFIT: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class TempfileControlFlag:
    ...
    ALLOW_IN_MEMORY_FILES: typing.ClassVar[
        TempfileControlFlag
    ]  # value = <TempfileControlFlag.ALLOW_IN_MEMORY_FILES: 0>
    ALLOW_TEMPORARY_FILES: typing.ClassVar[
        TempfileControlFlag
    ]  # value = <TempfileControlFlag.ALLOW_TEMPORARY_FILES: 1>
    __members__: typing.ClassVar[
        dict[str, TempfileControlFlag]
    ]  # value = {'ALLOW_IN_MEMORY_FILES': <TempfileControlFlag.ALLOW_IN_MEMORY_FILES: 0>, 'ALLOW_TEMPORARY_FILES': <TempfileControlFlag.ALLOW_TEMPORARY_FILES: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TensorIOMode:
    ...
    __members__: typing.ClassVar[
        dict[str, TensorIOMode]
    ]  # value = {'NONE': <TensorIOMode.NONE: 0>, 'INPUT': <TensorIOMode.INPUT: 1>, 'OUTPUT': <TensorIOMode.OUTPUT: 2>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TensorLocation:
    ...
    ]  # value = {'DEVICE': <TensorLocation.DEVICE: 0>, 'HOST': <TensorLocation.HOST: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TensorRTPhase:
    ...
    __members__: typing.ClassVar[
        dict[str, TensorRTPhase]
    ]  # value = {'BUILD': <TensorRTPhase.BUILD: 0>, 'RUNTIME': <TensorRTPhase.RUNTIME: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __ge__(self, other: typing.Any) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __gt__(self, other: typing.Any) -> builtins.bool: ...
...
class TilingOptimizationLevel:
    ...
    __members__: typing.ClassVar[
        dict[str, TilingOptimizationLevel]
    ]  # value = {'NONE': <TilingOptimizationLevel.NONE: 0>, 'FAST': <TilingOptimizationLevel.FAST: 1>, 'MODERATE': <TilingOptimizationLevel.MODERATE: 2>, 'FULL': <TilingOptimizationLevel.FULL: 3>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TopKOperation:
    ...
    __members__: typing.ClassVar[
        dict[str, TopKOperation]
    ]  # value = {'MAX': <TopKOperation.MAX: 0>, 'MIN': <TopKOperation.MIN: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TripLimit:
    ...
    Members:
      ...
      WHILE : Tensor is a scalar of type :class:`builtins.bool`. Loop terminates when its value is false.
    """
    ...
    __members__: typing.ClassVar[
        dict[str, TripLimit]
    ]  # value = {'COUNT': <TripLimit.COUNT: 0>, 'WHILE': <TripLimit.WHILE: 1>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class WeightsRole:
    ...
    __members__: typing.ClassVar[
        dict[str, WeightsRole]
    ]  # value = {'KERNEL': <WeightsRole.KERNEL: 0>, 'BIAS': <WeightsRole.BIAS: 1>, 'SHIFT': <WeightsRole.SHIFT: 2>, 'SCALE': <WeightsRole.SCALE: 3>, 'CONSTANT': <WeightsRole.CONSTANT: 4>, 'ANY': <WeightsRole.ANY: 5>}
    def __eq__(self, other: object) -> builtins.bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
