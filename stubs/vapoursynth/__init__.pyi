...
class _zsmooth:
    class _Core_bound:
        class Plugin(_VSPlugin):
            ...
            @_Wrapper.Function
            def TemporalMedian(self, clip: VideoNode, radius: int | None = None, planes: int | _SequenceLike[int] | None = None, scenechange: int | None = None) -> VideoNode: ...
            @_Wrapper.Function
    ...
    class _VideoNode_bound:
        class Plugin(_VSPlugin):
            ...
            @_Wrapper.Function
            def TemporalMedian(self, radius: int | None = None, planes: int | _SequenceLike[int] | None = None, scenechange: int | None = None) -> VideoNode: ...
            @_Wrapper.Function
