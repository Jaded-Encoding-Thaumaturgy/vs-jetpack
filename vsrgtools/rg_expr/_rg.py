...
def remove_grain_expr_11_12() -> str:
    return f"x 4 * {A2} {A4} {A5} {A7} + + + 2 * + {A1} {A3} {A6} {A8} + + + + 16 /"


def remove_grain_expr_17() -> str:
    return (
        f"{A1} {A8} min mil1! "
        f"{A1} {A8} max mal1! "
        f"{A2} {A7} min mil2! "
...
def remove_grain_expr_19() -> str:
    return f"{A1} {A2} {A3} {A4} {A5} {A6} {A7} {A8} + + + + + + + 8.0 /"


def remove_grain_expr_20() -> str:
    return f"x {A1} {A2} {A3} {A4} {A5} {A6} {A7} {A8} + + + + + + + + 9.0 /"


def remove_grain_expr_21_22() -> str:
    return (
        f"{A1} {A8} + 2 / av1! "
        f"{A2} {A7} + 2 / av2! "
        f"{A3} {A6} + 2 / av3! "
