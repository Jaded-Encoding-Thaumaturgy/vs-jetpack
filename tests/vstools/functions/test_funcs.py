...
def test_functionutil_bitdepth_tuple() -> None:
...
def test_functionutil_bitdepth_int() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_bitdepth_set() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_bitdepth_range() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_bitdepth_conversion_int_up() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_bitdepth_conversion_int_same() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
    result = FunctionUtil(clip, "FunctionUtilTest", bitdepth=8)
    assert result.work_clip.format.name == "YUV420P8"


def test_functionutil_bitdepth_conversion_tuple_up() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_color_family_conversion_gray_to_gray() -> None:
...
def test_functionutil_color_family_conversion_gray_to_rgb() -> None:
    clip = vs.core.std.BlankClip(format=vs.GRAY8)
...
def test_functionutil_color_family_conversion_yuv_to_gray() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
    result = FunctionUtil(clip, "FunctionUtilTest", color_family=vs.GRAY)
    assert result.work_clip.format.color_family == vs.GRAY
    assert not result.cfamily_converted
...
def test_functionutil_color_family_conversion_yuv_to_yuv() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_color_family_conversion_yuv_to_rgb() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
    result = FunctionUtil(clip, "FunctionUtilTest", color_family=vs.RGB, matrix=1)
    assert result.work_clip.format.color_family == vs.RGB
    assert result.cfamily_converted
...
def test_functionutil_color_family_conversion_rgb_to_gray() -> None:
...
def test_functionutil_color_family_conversion_rgb_to_yuv() -> None:
    clip = vs.core.std.BlankClip(format=vs.RGB24)
...
def test_functionutil_color_family_conversion_rgb_to_rgb() -> None:
    clip = vs.core.std.BlankClip(format=vs.RGB24)
...
def test_functionutil_color_conversions_yuv_to_rgb_without_matrix() -> None:
...
def test_functionutil_color_conversions_yuv_to_rgb_with_matrix() -> None:
    yuv_clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_color_conversions_gray_to_rgb_with_matrix() -> None:
...
def test_functionutil_color_conversions_rgb_to_yuv_without_matrix() -> None:
...
def test_functionutil_return_clip_yuv() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
    func_util = FunctionUtil(clip, "FunctionUtilTest", bitdepth=16)
    result = func_util.return_clip(func_util.work_clip)
...
def test_functionutil_return_clip_rgb() -> None:
    clip = vs.core.std.BlankClip(format=vs.RGB24)
    func_util = FunctionUtil(clip, "FunctionUtilTest", bitdepth=16)
    result = func_util.return_clip(func_util.work_clip)
...
def test_functionutil_num_planes_yuv() -> None:
...
def test_functionutil_num_planes_gray() -> None:
...
def test_functionutil_num_planes_rgb() -> None:
...
def test_functionutil_planes_0_yuv_to_rgb() -> None:
    clip = vs.core.std.BlankClip(format=vs.YUV420P8)
...
def test_functionutil_planes_0_rgb_to_yuv() -> None:
    clip = vs.core.std.BlankClip(format=vs.RGB24)
