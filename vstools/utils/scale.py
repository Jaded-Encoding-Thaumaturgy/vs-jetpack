...
def get_lowest_values(
    ...
    return normalize_seq(
        [get_lowest_value(fmt, False, range_in, family), get_lowest_value(fmt, True, range_in, family)], fmt.num_planes
    )
...
def get_peak_values(
    ...
    return normalize_seq(
        [get_peak_value(fmt, False, range_in, family), get_peak_value(fmt, True, range_in, family)], fmt.num_planes
    )
